...
def evaluate(
    ...
    file_path = "../store_results/CHI/omega/evaluate_server_CHI_bulyan_omega.txt"
    # Open the file for writing
    with open(file_path, "a") as file:
...
class FedCrime(fl.server.strategy.Strategy):
    ...
    def aggregate_fit(
        ...
        parameters_aggregated = ndarrays_to_parameters(aggregate_krum(weights_results, num_malicious_clients, num_clients_to_keep))
