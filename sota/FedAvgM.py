...
def evaluate(
    ...
    file_path = "../store_results/CHI/omega/evaluate_server_CHI_avgm_omega.txt"
    # Open the file for writing
    with open(file_path, "a") as file:
...
class FedCrime(fl.server.strategy.Strategy):
    ...
    def initialize_parameters(
        ...
        self.initial_parameters = fl.common.ndarrays_to_parameters(ndarrays)
    ...
    def aggregate_fit(
        ...
        if server_round > 1:
            ...
            print("I am round", server_round, "Momentum created")
